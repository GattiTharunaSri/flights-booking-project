...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="aiflow-sample-project-dev")
    bq_project = Variable.get("bq_project", default_var="project-03803ccd-8fd5-4d10-a60")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "github-actions-sa@project-03803ccd-8fd5-4d10-a60.iam.gserviceaccount.com",
